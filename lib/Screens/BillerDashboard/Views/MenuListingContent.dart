...
class MenuListingContent extends StatelessWidget {
  const MenuListingContent({super.key});
  ...
  Widget build(BuildContext context) {
    return GetBuilder<DashboardController>(
      builder: (controller) {
   print("================================");
    print("MenuListingContent Build Called");
    print("Menus Count: ${controller.menus.length}");
    print("Categories Count: ${controller.categories.length}");
    print("Selected Category: ${controller.selectedCategory?.id}");
